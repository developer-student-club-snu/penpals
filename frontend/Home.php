        ...
        <div class="convo_area col-md-10">
            <div class="convo_header" >
                ...
                <div class = "col-md-1 parent dropdown" id="dropdown">
                    ...
                    <div id="modal_nickname" style="top:35%;" class="modal fade" role="dialog">
                    ...
                    <div id="modal_end" class="modal fade" style="top:35%;" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">                               
                    ...
                    <div id="modal_start" class="modal fade" style="top:35%;" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">                    
                                <label id="waitlist"></label>                                    
